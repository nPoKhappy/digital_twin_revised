...
OUTPUT_PERTURB_FILENAME = "LHS/LHS_air2_t2_in_range_perturbation.csv"
...
def main():
    ...
    variable_ranges = {
        ...
        "ACIDGAS.P.P": (1.66, 1.69),  # acidgas_P, small local change around 1.6722 bar
    }
    ...
    plot_dir = os.path.join(base_dir, "LHS_Air2_T2_Local_Check_Plots")
