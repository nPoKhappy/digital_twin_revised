"""Step-wise PGIN training with directional gain and steady-state value losses.

This standalone variant preserves the original step-wise autoregressive
training path and adds an Excel steady-state target loss in place of the
gain-magnitude constraint.
"""
...
def main(config_path: str):
    ...
    ss_loss_weight = config['training'].get('ss_loss_weight', 0.05)
